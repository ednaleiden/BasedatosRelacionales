 ...
 <nav class="navbar navbar-light bg-light " >
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 ">
            ...
            <li class="nav-item text-center" >
              <a class="nav-link active" aria-current="page" href="clientes.php">Cliente</a>
            </li>
            <li class="nav-item text-center" >
  ...
  <div class="card card-body ">
         <form action="save.php" method="GET">
            ...
            <div class="from-group mt-3">
               <input  type="number"  name="telefono" rows="2" class="form-control"  placeholder="Telefono">
            </div>
            <div class="from-group mt-3">
               <input type="email" name="correo" rows="2" class="form-control" placeholder="Correo">
            </div>
            <input type="submit" class="btn btn-success btn-block mt-3" name="save" value="Crear Cliente">
            </button>
         </form>
      </div>
    ...
    while ($row = mysqli_fetch_array($result_cliente)) {?> 
      ...
      <tr>
          ...
          <td><?php echo $row ['correo']?></td>
                 ...
                 <td>
                   <a href="edit.php?id_cliente=<?php echo $row['id_cliente']?>"class="btn btn-secondary">
                    ...
                    <a href="delete.php? id_cliente=<?php echo$row['id_cliente']?>"class="btn btn-danger">
       ...
       if(isset($_GET['enviar'])){
        ...
        $consulta = $conn->query("SELECT * FROM cliente WHERE id_cliente LIKE '%$busqueda%' OR 	nombre LIKE '%$busqueda%' OR apellido LIKE '%$busqueda%' OR telefono LIKE '%$busqueda%' OR correo LIKE '%$busqueda%' ");
