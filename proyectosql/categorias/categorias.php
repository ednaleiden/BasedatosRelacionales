          ...
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 ">
            ...
            <li class="nav-item dropdown text-center">
              ...
              <ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown">
                 <li><a class="dropdown-item" href="../detalle/detalle.php">Detalle</a></li>
    ...
    <div class="col-md-8 ">
      <table class="table table-dark table-striped">
        <thead>   
          ...
          <tbody>
            <?php
              $query= "SELECT * FROM cartegoria";
              $result_cartegoria =  mysqli_query($conn,$query);
              while($row = mysqli_fetch_array($result_cartegoria)) {?>
                <tr>
                  ...
                  <td>
                    <a href="edit.php?
                    id_categoria=<?php echo $row['id_categoria']?>"
                    class="btn btn-secondary">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                          <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
                          </svg></a>
                          <a href="delete.php? id_categoria=<?php echo $row['id_categoria']?>"class="btn btn-danger">
      ...
      if(isset ($_GET['enviar'])){
        ...
        $consulta = $conn->query("SELECT * FROM cartegoria WHERE id_categoria LIKE '%$busqueda%' OR nombre LIKE '%$busqueda%' OR id_categoria LIKE '%$busqueda%'");
