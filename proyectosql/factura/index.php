  ...
  <nav class="navbar navbar-light bg-light " >
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 ">
            ...
            <li class="nav-item text-center" >
              <a class="nav-link active" aria-current="page" href="index.php">Factura</a>
            </li>
      ...
      <div class="card card-body">
         <form action="save.php" method="GET">
            <div class="from-group">
               <input type="text" name="id_cliente" class="form-control" placeholder="ID del cliente"autofocus>
            </div>
            ...
            <!---<div class="from-group mt-3">
               <textarea name="fecha" rows="2" class="form-control" placeholder="Fecha de la factura"></textarea>
            </div>--->
        ...
        <thead>
          ...
          <tbody>
            <?php
              ...
              while($row = mysqli_fetch_array($result_factura)){?>
              <tr>
                <td><?php echo $row['num_factura']?></td>
                <td><?php echo $row['id_cliente']?></td>
                <td><?php echo $row['fecha']?></td>
                <td>
                <a href="edit.php?num_factura=<?php echo $row['num_factura']?>"class="btn btn-secondary">
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                     <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
                     </svg>
                    </a>
                    <a href="delete.php?num_factura=<?php echo $row['num_factura']?>"class="btn btn-danger">
    ...
    if(isset ($_GET['enviar'])){
      $busqueda = $_GET['busqueda'];
        $consulta = $conn->query("SELECT * FROM factura WHERE num_factura LIKE '%$busqueda%' OR id_cliente LIKE '%$busqueda%' OR fecha LIKE '%$busqueda%'");
